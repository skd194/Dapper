...
namespace DDDUsingDapper.Infrastructure.Repository.GenericRepository
{
    internal class GenericProcRespository
    {
        //private IConfiguration _configuration { get; set; }

        public GenericProcRespository(IConfiguration configuration)
        {
